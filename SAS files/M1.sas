...
143.1     140.3     139.4     140.7     139.6     140.4     141.2     140.9     141.3     141.7     142.8     144.7
    ...
    918.1     916.5
run;
data a; set a; new = 1/sqrt(m1);run;
*proc print data=a;run;
*proc means;
symbol1 c=red i=join v=star;
symbol2 c=green i=join v=plus;
symbol3 c=blue i=join v=none;
proc gplot data=a; plot m1*N=1 new*N=2;
run;
proc arima data=a;
 i var=new(1,12) noprint;
* i var=M1(1, 12) noprint;
 e q=(1  3 7 9 10  12 13) noint noprint;
 f out=out lead=15 id=n;
run;
data new_out;set out;  newl95=1/l95**2;newu95=1/u95**2;
newforecast=1/forecast**2; newm1=1/new**2;run;
proc gplot data=new_out; where n > 350;
   plot newm1*n=1 newforecast*n=2 newl95*n=3 newu95*n=3/overlay;
   run;
